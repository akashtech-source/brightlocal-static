                    ...
                    >
                        <Card className="ceo">
                            <div style={{textAlign: 'center'}}>
                                ...
                                <i>`BrightLocal tools are a must-have for marketers looking to optimize their organic search results.`</i>
                                </h2>
                                <Image src={user} alt="user"></Image>
                                <h4 style={{color: 'grey'}}>Nielson Hall</h4>
                                <p style={{color: 'grey'}}>Head of SEO</p>
                                <p style={{color: 'grey'}}>iProspect</p>
